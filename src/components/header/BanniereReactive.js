...
function BanniereReactive() {
    ...
    return (
        <div>
            <nav className={`fixed top-0 left-0 w-full ${isScrolled ? 'bg-secondary shadow-lg' : 'bg-transparent'} transition-all ease-in-out duration-800 ${isScrolled ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                <ul className='flex gap-[20px] justify-center py-[10px]'>
                    ...
                    <li><a href='#' className='py-[15px] px-[5px] hover:bg-primary rounded text-text flex gap-2 Raleway-h3'><Camera/> Projet Graphique</a></li>
